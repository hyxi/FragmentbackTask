...
package com.example.user.fragmentbacktask.view.smoothapplayout.base;

import android.view.View;

import com.example.user.fragmentbacktask.view.smoothapplayout.SmoothAppBarLayout;
...
public interface ObservableFragment {
   ...
   *
   * @return CustomNestedScrollView or RecyclerView
   */
