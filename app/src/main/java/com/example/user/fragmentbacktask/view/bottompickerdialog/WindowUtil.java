...
public class WindowUtil {
	...
	public static boolean resize(View view, float horizontalRatio,
			float verticalRatio) {
		if (view == null)
			return false;
		/* 重新计算宽高 */
	...
	public static boolean resizeStrictly(View view, float horizontalRatio,
			float verticalRatio) {
		if (view == null)
			return false;
		/* 重新计算宽高 */
	...
	public static boolean resizeWidthAndHeight(View view,
			float horizontalRatio, float verticalRatio) {
		if (view == null)
			return false;
	 ...
	 * @return
	 */
	public static boolean repadding(View view, float horizontalRatio,
			float verticalRatio) {
		if (view == null)
			return false;
		view.setPadding((int) (view.getPaddingLeft() * horizontalRatio),
	 ...
	 * @return
	 */
	public static void remargin(View view, float horizontalRatio,
			float verticalRatio) {
	...
	public static boolean resizeRecursivelyWithRespectiveRatio(View view) {
		return resizeRecursively(view, SCALE_RATIO_HORIZONTAL,
	...
	public static boolean resizeRecursivelyWithVerticalRatio(View view) {
		return resizeRecursively(view, SCALE_RATIO_VERTICAL,
				SCALE_RATIO_VERTICAL);
	}
	 ...
	 * @return
	 */
	private static boolean resizeRecursively(View view, float horizontalRatio,
			float verticalRatio) {
		if (view == null)
			return false;
		/* 是否为严格模式 */
	 ...
	 * @return
	 */
	private static boolean resizeStrictRecursively(View view,
			float horizontalRatio, float verticalRatio) {
		if (view == null)
			return false;
	...
	public static boolean setWidth(View view, int designedWidthResId) {
		float designedWidth = TestApplication.getContext().getResources()
				.getDimension(designedWidthResId);
	...
	public static boolean setHeight(View view, int designedHeightResId) {
		if (view == null)
			return false;
		float designedHeight = TestApplication.getContext().getResources()
				.getDimension(designedHeightResId);
		LayoutParams params = null;
		if (view instanceof ViewGroup)
			params = view.getLayoutParams();
		if (params == null)
	 ...
	 * @return 是否成功设置
	 */
	public static boolean setSize(View view, int designedWidthResId,
			int designedHeightResId) {
		float designedWidth = TestApplication.getContext().getResources()
				.getDimension(designedWidthResId);
		float designedHeight = TestApplication.getContext().getResources()
				.getDimension(designedHeightResId);
	...
	public static boolean setTextSize(TextView view, int designedTextSizeResId) {
		if (view == null)
			return false;
		float designedSize = TestApplication.getContext().getResources()
				.getDimension(designedTextSizeResId);
	 ...
	 * @return
	 */
	public static boolean setMargin(View view, int left, int top, int right,
			int bottom) {
		MarginLayoutParams marginParams = null;
		try {
			marginParams = (MarginLayoutParams) view.getLayoutParams();
	 ...
	 * @return
	 */
	public static boolean setPadding(View view, int left, int top, int right,
			int bottom) {
		if (view == null)
			return false;
	...
	public static float getHorizontalScaledDimen(int heightResId) {
		return TestApplication.getContext().getResources().getDimension(heightResId)
	...
	public static int getWindowWidth() {
		...
		dm = TestApplication.getContext().getResources().getDisplayMetrics();
		if (dm == null)
			return 0;
	...
	public static float computeDimen(int resId) {
		return TestApplication.getContext().getResources().getDimension(resId);
	}
	...
	public static void computeScaleRatio() {
		...
		if (windowWidth == 0 || windowHeight == 0)
			return;
		int designedWidth = (windowWidth > windowHeight) ? UI_DESIGN_PORTRAIT_SIZE
				: UI_DESIGN_LANDSCAPE_SIZE;
		int designedHeight = (windowWidth > windowHeight) ? UI_DESIGN_LANDSCAPE_SIZE
				: UI_DESIGN_PORTRAIT_SIZE;
		SCALE_RATIO_HORIZONTAL = (float) windowWidth / (float) designedWidth;
		SCALE_RATIO_VERTICAL = (float) windowHeight / (float) designedHeight;

		float ratioDesigned = (float) UI_DESIGN_PORTRAIT_SIZE
				/ (float) UI_DESIGN_LANDSCAPE_SIZE;
		...
		SCALE_RATIO = ratioDevice >= ratioDesigned ? SCALE_RATIO_HORIZONTAL
				: SCALE_RATIO_VERTICAL;
	}
	...
	public static boolean isLandscape() {
		return TestApplication.getContext().getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE;
	}
	...
	public static int dp2px(float dip) {
		float f = TestApplication.getContext().getResources().getDisplayMetrics().density;
	...
	public static int getStatusBarHeight() {
		...
		try {
			...
			statusBarHeight = TestApplication.getContext().getResources()
	...
	public static void computeWindowRotation() {
		WindowManager windowManager = (WindowManager) TestApplication.getContext()
