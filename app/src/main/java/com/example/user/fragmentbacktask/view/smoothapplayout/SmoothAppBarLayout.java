...
package com.example.user.fragmentbacktask.view.smoothapplayout;
...
import com.example.user.fragmentbacktask.view.smoothapplayout.base.ObservableFragment;
import com.example.user.fragmentbacktask.view.smoothapplayout.base.ObservablePagerAdapter;
import com.example.user.fragmentbacktask.view.smoothapplayout.base.ScrollFlag;
import com.example.user.fragmentbacktask.view.smoothapplayout.base.ScrollTargetCallback;
import com.example.user.fragmentbacktask.view.smoothapplayout.base.Utils;
...
public class SmoothAppBarLayout extends AppBarLayout {
  ...
  private com.example.user.fragmentbacktask.view.smoothapplayout.base.OnOffsetChangedListener mSyncOffsetListener;
...
//        CustomNestedScrollView nestedScrollView = (CustomNestedScrollView) view;
//        if (animate) {
...
//    }
  ...
  private void setSyncOffsetListener(com.example.user.fragmentbacktask.view.smoothapplayout.base.OnOffsetChangedListener syncOffsetListener) {
...
//        layout.setSyncOffsetListener(new com.example.user.fragmentbacktask.view.smoothapplayout.base.OnOffsetChangedListener() {
//          @Override
