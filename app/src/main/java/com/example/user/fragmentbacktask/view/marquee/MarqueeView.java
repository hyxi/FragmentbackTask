package com.example.user.fragmentbacktask.view.marquee;
...
import com.example.user.fragmentbacktask.view.marquee.util.AnimationListenerAdapter;
import com.example.user.fragmentbacktask.view.marquee.util.OnItemClickListener;
import com.example.user.fragmentbacktask.view.marquee.util.Util;
