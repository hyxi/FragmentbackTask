...
import com.example.user.fragmentbacktask.view.smoothapplayout.base.ObservableNestedScrollView;
import com.example.user.fragmentbacktask.view.smoothapplayout.base.ObservableRecyclerView;
import com.example.user.fragmentbacktask.view.smoothapplayout.base.OnScrollListener;
...
public abstract class BaseBehavior extends AppBarLayout.Behavior {
  ...
  private BaseDragCallback mDragCallbackListener;
